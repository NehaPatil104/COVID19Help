<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="displayVaccineCenter.aspx.cs" Inherits="COVID19Help.displayVaccineCenter" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [vaccination]"></asp:SqlDataSource>
                        <br />
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" CssClass="table table-striped table-bordered table-hover">
                            <Columns>
                                ...
                                <asp:BoundField DataField="facilityCategory" HeaderText="Facility Category" SortExpression="facilityCategory" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />
                                ...
                                <asp:BoundField DataField="facilityName" HeaderText="Facility Name" SortExpression="facilityName" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />
